/*	This program will create ALL knotted polygons in a LxM tube, with chosen span. Polygon must go the full span. ALSO-polys must have a min number of edges. 	*/
...
/************************************************************************************************/
	...
	sprintf(filename, "CreatorAll_PKshrunkPolysL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
...
#include "recursivegenerate_all_PKshrunk.c"
