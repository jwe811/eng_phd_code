...
printf("2x2 COMPACT SPECIAL CASE. GOING TO MAKE CHANGES TO USE A MATRIX WHICH IS IRREDUCIBLE AND APERIODIC\n");
printf("Using Trying2.c\n");
...
//BUT, if it's a section which can only occur in EVEN sections, set it to zero. (uses global vector testvector2)
