...
*/
	...
	sprintf(filename, "2SAP_L_EvectorHam_TS_L%dM%d.txt", L, M);
...
#include "pw_meth_ts_LRvec_fcheck_2SAP_HAM.c" /* for applying the power method to the section-section matrix */
