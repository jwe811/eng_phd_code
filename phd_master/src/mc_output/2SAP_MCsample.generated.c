...
#define dom_evalue 180.511702878389116
...
*/
	...
	printf("\nNOW SAMPLING 2SAPs: %d samples from L=%d, M=%d, span=%d\n", samplesize, L, M, totalspan);
		...
		sprintf(filename, "data/2SAPs/MC2SAPsL%dM%dspan%drun%dnum%lu.txt", L, M, totalspan, runnum, filenum);
