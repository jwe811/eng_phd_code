...
#define x_L 0.33			/* left end point to use in bracketing method to find x_0        */
#define x_R 0.361863		/* right end point to use in bracketing method to find x_0       */
...
#else
#define max_sections 186180	//just an estimate for 5x1...  
#endif
...
unsigned long int sectionkey[vec_length];	//will hold valid section nums. index is key num
int dupcounter=0;
...
//	printf("OGinNum=%d\n", inNum);
	//reset inNum to it's key number.
	i=1;
	int found=0;
