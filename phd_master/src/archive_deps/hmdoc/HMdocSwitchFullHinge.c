...
ALSO, FULLHINGE VERSION, SO VALID 2-SPANS MUST OCCUPY ALL VERTICES IN HINGE.
...
#define	connectivity_inv 1	/* When the connectivity is known its inverse is defined here.   */


#define f_L -2.644501			/* left end point to use in bracketing method to find f_0        */
#define f_R -2.644503		/* right end point to use in bracketing method to find f_0       */
...
/**************************************************************************/
	...
	printf("Set x_0 = 1.  Looking for f_0 = fval which gives a dominant eigenvalue of 1.\n");
...
#include "../analysis/statistics/get_Beta_ts_force.c"      /* for calculating Beta */ 
#endif

#if defined(SS)
#include "../transfer_matrix/pw_meth_ss_LRvec_force.c" /* for applying the power method to the section-section matrix */
#include "../analysis/statistics/get_Beta_ss_force.c"	/* for calculating Beta */
#endif
...
#if defined(TS)
#include "../analysis/statistics/sumtoone_ts_force.c"
//#include "../sections/enterpatstspan_ts.c"
#include "../sections/enterpats_ts_force.c"
#include "../analysis/statistics/transprobcheck_ts_force.c"
#else
#include "../analysis/statistics/sumtoone_ss_force.c"
//#include "../sections/enterpatstspan_ss.c"
#include "../sections/enterpats_ss_force.c"
#include "../analysis/statistics/transprobcheck_ss_force.c"
