...
for (i=1;i <= 10;i++){slot_num[i]=0;} /* This is necessary to initialize the array to contain zero elements */
	...
	for (i = 0; i <= M; i++) {
		for (j = 0; j <= L; j++) {
			edge_num=endtemplate[i][j];/*assign number of edge determined by i and j to edge_num */
...
for (i=1;i <= 10;i++){slot_num[i]=0;} /* This is necessary to initialize the array to contain zero elements */
	...
	for (i = 0; i <= M; i++) {
		for (j = 0; j <= L; j++) {
			edge_num=endtemplate2[i][j];/*assign number of edge determined by i and j to edge_num */
							   /*this will be zero if there is no edge */
