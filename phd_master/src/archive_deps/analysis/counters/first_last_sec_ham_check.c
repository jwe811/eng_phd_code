...
//assumes tube is in the z-direction, x corresponds to L, y corresponds to M.
...
#define	L 3
#define	M 1
#define	totalspan 4	//span of polygons being looked at
...
//			printf("starting point is %d, %d, %d\n", x, y, z);
			...
			//check if intermediate hinges are filled.
			filled=1;
			for(i=0; i<=M; i++){
				for(j=0; j<=L; j++){
