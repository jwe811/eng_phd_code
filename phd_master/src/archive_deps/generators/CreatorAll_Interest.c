...
start and end sections only have two edges. Polygon must go the full span.	*/
...
/************************************************************************************************/
	...
	sprintf(filename, "CreatorAll_InterestPolysL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
...
#include "recursivegenerate_all_interest.c"
