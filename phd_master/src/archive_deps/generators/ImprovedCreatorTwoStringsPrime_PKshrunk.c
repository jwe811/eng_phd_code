...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sprintf(filename, "ImpCreatorTwoStringsPrime_PKshrunkL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
	...
	sprintf(trackingname, "tracking_ImpCr2stringsPrimePKshrL%dM%dspan%d.txt", L, M, totalspan);
...
#include "ImprovedRecurGen_TwoStringPrime.c"
