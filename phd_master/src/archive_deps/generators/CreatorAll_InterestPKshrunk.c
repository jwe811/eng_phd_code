...
//Changes in v2:	New polygon file every 100000 polys
...
//changes: got rid of all version numbers... changed tracking to tracking_CrAllIntPKshr.txt
...
#define	totalspan 7		/* span of the polygon that will be generated (must be >=3)	*/
...
/************************************************************************************************/
	...
	sprintf(trackingname, "tracking_CrAllIntPKshrL%dM%dspan%d.txt", L, M, totalspan);
...
#include "recursivegenerate_all_interestPKshrunk_v3.c"
