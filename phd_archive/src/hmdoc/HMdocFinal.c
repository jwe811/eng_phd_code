...
void				probkspan6(double, double, double); //tube in x-direction
...
/*************************************************************************************************/
	...
	printf("There are a total of %9lu   valid   section orderings.\n\n", valid_sections);
/************************************************************************************************/
...
#if defined(thex)
	printf("running powmethod with x=%f\n", connectivity_inv);
...
#include "../analysis/statistics/probkspan_ss6.c"
