...
#define	g 0
#define	connectivity_inv exp(g)	/* When the connectivity is known its inverse is defined here.   */


#define f_L -5.106970			/* left end point to use in bracketing method to find f_0        */
#define f_R -5.106968			/* right end point to use in bracketing method to find f_0       */
...
/**************************************************************************/
	...
	printf("Set x_0 = %f.  Looking for f_0 = fval which gives a dominant eigenvalue of 1.\n", connectivity_inv);
...
#include "../analysis/statistics/prob_check_ss_force.c"
...
#include "../analysis/statistics/probkspan_ss_force.c"
#include "../analysis/statistics/probkspan_ss_force2.c"
#include "../analysis/statistics/probkspan_ss_force3.c"
