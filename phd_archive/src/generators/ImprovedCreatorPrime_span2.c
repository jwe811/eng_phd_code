...
#define	totalspan 2		/* span of the polygon that will be generated (must be >=3)	*/
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sprintf(filename, "ImpCreatorPrimePolysL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
...
//							printf("found a duplicate. not printing it.\n");
	...
	*/
	//////////////////////////////////////////////////////////////////////////////
						...
						//now CLOSE OFF POLY! (span 2 version)
						...
						lastsection = current_hinge_span[firstsection]->outorder;
						endhingetoadd = firstendhinge[lastsection];
						while(endhingetoadd->nextendhinge!=NULL){
				...
				*/
					...
					//			printf("GOT TO HERE. POLYGON IS CREATED\n");
								...
								if(filetotal>=maxpolys){	//then we need to close up the current file, and create a new one to write to.
									...
									fclose(fp);
									filenum++;
									sprintf(filename, "ImpCreatorPrimePolysL%dM%dspan%dnum%d.txt", passedL, passedM, totalspan, filenum);
									fp = fopen(filename, "w");	//create or overwrite the file "filename
...
#include "ImprovedRecurGenPrime.c"
