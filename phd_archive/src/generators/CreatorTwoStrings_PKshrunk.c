...
//Changes in v2:	New polygon file every 100000 polys (maxpolys)
...
//changes: got rid of all version numbers... changed tracking to tracking_Cr2stringsPKshr.txt
...
/************************************************************************************************/
	...
	sprintf(filename, "CreatorTwoStrings_PKshrunkPolysL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
	...
	sprintf(trackingname, "tracking_Cr2stringsPKshrL%dM%dspan%d.txt", L, M, totalspan);
	...
	*/
		...
		*/
		...
		//								printf("counter=%d\n", counter);
							...
							//DO THE CHECK FOR DUPLICATES HERE, SINCE THE LEFT ENDHINGE AND THE FIRST SECTION ARE NOW CREATED AND STORED IN PRINTABLEWALK[].
...
#include "recursivegenerateTwoStrings_PKshrunk.c"
