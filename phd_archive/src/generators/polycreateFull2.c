...
#define	totalspan 2		/* span of generated polygon (z-direction)	*/
...
unsigned short int thepolygon[vM*vL*(totalspan+1)];		//this global array will hold the polygon (list of directions). maximum number of directions will be vM*vL
...
void goposx(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the positive x direction, when called, DO NOT know if this is a valid move when called
void gonegx(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the negative x direction, when called, DO NOT know if this is a valid move when called
void goposy(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the positive y direction, when called, DO NOT know if this is a valid move when called
void gonegy(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the negative y direction, when called, DO NOT know if this is a valid move when called
void goposz(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the positive z direction, when called, DO NOT know if this is a valid move when called
void gonegz(unsigned short int prevx, unsigned short int prevy, unsigned short int prevz, FILE* fp);	//go in the negative z direction, when called, DO NOT know if this is a valid move when called
