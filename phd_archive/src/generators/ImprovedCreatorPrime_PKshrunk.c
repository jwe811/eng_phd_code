/*	This program will create ALL polygons in a LxM tube, with chosen span. Polygon must go the full span.ALSO-polys must have a min number of edges. 	*/
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sprintf(filename, "ImpCreatorPrime_PKshrunkPolysL%dM%dspan%dnum%d.txt", L, M, totalspan, filenum);
	...
	for(firstsection=1113; firstsection<=max_sections; firstsection++){
		printsection(1113);
...
//							printf("found a duplicate. not printing it.\n");
	...
	*/
	...
	printf("\nDone generating all polygons with >= %d edges AFTER BEING SHRUNK in %f seconds.\n\n", minedges, (double)clock()/(double)CLOCKS_PER_SEC);
	fclose(fp);
...
#include "ImprovedRecurGenPrime_PKshrunk.c"
