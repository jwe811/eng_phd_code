//This program will print info on what the tspans look like. It is abbreviated from MCsample.c
...
//compliled with: gcc -lm -Wall -O3 -o MCsample_print_tspans.o MCsample_print_tspans.c
//ran using ./MCsample_print_tspans.o
...
#define	totalspan 100		// span of sampled SAPs
#define	samplesize 100	// number of samples desired
#define	runnum 1
