/*	This program will count all HAMILTONIAN polygons in a LxM tube, with certain edge length.  */
...
#define	totaledges 36		/* Number of edges in polygons to be counted	*/
...
//	printf("\ncurlength=%d\n", curlength);	//should be zero
	...
	printf("Number of polys with %d edges: %d million + %d\n", totaledges, millions, grand);
