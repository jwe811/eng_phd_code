...
//v2
	...
	int prevtype=0; //keeps track of the previous link type. need to subtract one at the end, cause it prints the last one twice.
	                //1 for unlink, 2 for poshopf, 3 for neghopf.
	...
	for(filenum=1; filenum<=totalfiles; filenum++){	//for each knot file
	  filecounter=0;
	  sprintf(filename, "MC2SAPsHamL%dM%dspan%drun%dnum%d_LP.txt_knot_new", L, M, totalspan, runnum, filenum); //name of knot file
...
////v2
		        else if ( strcmp(line, "n3.1a\n")==0 ){
			  n3_1a++;
			  prevtype=107;
			}
		        else if ( strcmp(line, "n3.1b\n")==0 ){
			  n3_1b++;
			  prevtype=108;
			}
		        else if ( strcmp(line, "n3.1c\n")==0 ){
			  n3_1c++;
			  prevtype=109;
			}
		        else if ( strcmp(line, "n3.1d\n")==0 ){
			  n3_1d++;
			  prevtype=110;
			}
		        else if ( strcmp(line, "n3.1sa\n")==0 ){
			  n3_1sa++;
			  prevtype=111;
			}
		        else if ( strcmp(line, "n3.1sb\n")==0 ){
			  n3_1sb++;
			  prevtype=112;
			}
		        else if ( strcmp(line, "n3.1sc\n")==0 ){
			  n3_1sc++;
			  prevtype=113;
			}
		        else if ( strcmp(line, "n3.1sd\n")==0 ){
			  n3_1sd++;
			  prevtype=114;
			}
/////
		        else if ( strcmp(line, "o3.1a\n")==0 ){
			  o3_1a++;
			  prevtype=115;
			}
		        else if ( strcmp(line, "o3.1b\n")==0 ){
			  o3_1b++;
			  prevtype=116;
			}
		        else if ( strcmp(line, "o3.1c\n")==0 ){
			  o3_1c++;
			  prevtype=117;
			}
		        else if ( strcmp(line, "o3.1d\n")==0 ){
			  o3_1d++;
			  prevtype=118;
			}
		        else if ( strcmp(line, "o3.1sa\n")==0 ){
			  o3_1sa++;
			  prevtype=119;
			}
		        else if ( strcmp(line, "o3.1sb\n")==0 ){
			  o3_1sb++;
			  prevtype=120;
			}
		        else if ( strcmp(line, "o3.1sc\n")==0 ){
			  o3_1sc++;
			  prevtype=121;
			}
		        else if ( strcmp(line, "o3.1sd\n")==0 ){
			  o3_1sd++;
			  prevtype=122;
			}
		        else if ( strcmp(line, "l4.1a\n")==0 ){
			  l4_1a++;
			  prevtype=123;
			}
		        else if ( strcmp(line, "l4.1b\n")==0 ){
			  l4_1b++;
			  prevtype=124;
			}
		        else if ( strcmp(line, "l4.1c\n")==0 ){
			  l4_1c++;
			  prevtype=125;
			}
		        else if ( strcmp(line, "l4.1d\n")==0 ){
			  l4_1d++;
			  prevtype=126;
			}
		        else if ( strcmp(line, "u4.1a\n")==0 ){
			  u4_1a++;
			  prevtype=127;
			}
		        else if ( strcmp(line, "u4.1b\n")==0 ){
			  u4_1b++;
			  prevtype=128;
			}
		        else if ( strcmp(line, "u4.1c\n")==0 ){
			  u4_1c++;
			  prevtype=129;
			}
		        else if ( strcmp(line, "u4.1d\n")==0 ){
			  u4_1d++;
			  prevtype=130;
			}
		        else if ( strcmp(line, "n4.1a\n")==0 ){
			  n4_1a++;
			  prevtype=131;
			}
		        else if ( strcmp(line, "n4.1b\n")==0 ){
			  n4_1b++;
			  prevtype=132;
			}
		        else if ( strcmp(line, "n4.1c\n")==0 ){
			  n4_1c++;
			  prevtype=133;
			}
		        else if ( strcmp(line, "n4.1d\n")==0 ){
			  n4_1d++;
			  prevtype=134;
			}
		        else if ( strcmp(line, "8.2.12a\n")==0 ){
			  eighttwelve_a++;
			  prevtype=135;
			}
		        else if ( strcmp(line, "8.2.12b\n")==0 ){
			  eighttwelve_b++;
			  prevtype=136;
			}
		        else if ( strcmp(line, "8.2.12c\n")==0 ){
			  eighttwelve_c++;
			  prevtype=137;
			}
		        else if ( strcmp(line, "8.2.12d\n")==0 ){
			  eighttwelve_d++;
			  prevtype=138;
			}

			else{	//9 crossing or newtype link type
				if( atoi(&line[0])==9 ){
//					printf("ninecrossing\n");
					nine_crossing++;
					prevtype=-9;
...
///////v2
		else if (prevtype==107){
		  n3_1a--;
		}
		else if (prevtype==108){
		  n3_1b--;
		}
		else if (prevtype==109){
		  n3_1c--;
		}
		else if (prevtype==110){
		  n3_1d--;
		}
		else if (prevtype==111){
		  n3_1sa--;
		}
		else if (prevtype==112){
		  n3_1sb--;
		}
		else if (prevtype==113){
		  n3_1sc--;
		}
		else if (prevtype==114){
		  n3_1sd--;
		}
		else if (prevtype==115){
		  o3_1a--;
		}
		else if (prevtype==116){
		  o3_1b--;
		}
		else if (prevtype==117){
		  o3_1c--;
		}
		else if (prevtype==118){
		  o3_1d--;
		}
		else if (prevtype==119){
		  o3_1sa--;
		}
		else if (prevtype==120){
		  o3_1sb--;
		}
		else if (prevtype==121){
		  o3_1sc--;
		}
		else if (prevtype==122){
		  o3_1sd--;
		}
		else if (prevtype==123){
		  l4_1a--;
		}
		else if (prevtype==124){
		  l4_1b--;
		}
		else if (prevtype==125){
		  l4_1c--;
		}
		else if (prevtype==126){
		  l4_1d--;
		}
		else if (prevtype==127){
		  u4_1a--;
		}
		else if (prevtype==128){
		  u4_1b--;
		}
		else if (prevtype==129){
		  u4_1c--;
		}
		else if (prevtype==130){
		  u4_1d--;
		}
		else if (prevtype==131){
		  n4_1a--;
		}
		else if (prevtype==132){
		  n4_1b--;
		}
		else if (prevtype==133){
		  n4_1c--;
		}
		else if (prevtype==134){
		  n4_1d--;
		}
		else if (prevtype==135){
		  eighttwelve_a--;
		}
		else if (prevtype==136){
		  eighttwelve_b--;
		}
		else if (prevtype==137){
		  eighttwelve_c--;
		}
		else if (prevtype==138){
		  eighttwelve_d--;
		}

		else if (prevtype==-9){
			printf("last link was nine_crossing\n");
			nine_crossing--;
		}
		else{
	...
	printf("4_1d: %d\n", fouroned);
	printf("5_1a: %d\n", fiveonea);
	printf("5_1b: %d (ignore)\n", fiveoneb);
	printf("5_1c: %d\n", fiveonec);
	printf("5_1d: %d (ignore)\n", fiveoned);
	printf("6_1a: %d\n", sixonea);
	printf("6_1b: %d\n", sixoneb);
	printf("6_1c: %d\n", sixonec);
	printf("6_1d: %d\n", sixoned);
	...
	printf("7_2d: %d\n", seventwod);
	printf("7_3a: %d\n", seventhreea);
	printf("7_3b: %d (ignore)\n", seventhreeb);
	printf("7_3c: %d\n", seventhreec);
	printf("7_3d: %d (ignore)\n", seventhreed);
	printf("7_4a: %d\n", sevenfoura);
	printf("7_4b: %d (ignore)\n", sevenfourb);
	printf("7_4c: %d\n", sevenfourc);
	printf("7_4d: %d (ignore)\n", sevenfourd);
	printf("7_5a: %d\n", sevenfivea);
	printf("7_5b: %d\n", sevenfiveb);
	printf("7_5c: %d\n", sevenfivec);
	printf("7_5d: %d\n", sevenfived);
	printf("7_6a: %d\n", sevensixa);
	printf("7_6b: %d (ignore)\n", sevensixb);
	printf("7_6c: %d\n", sevensixc);
	printf("7_6d: %d (ignore)\n", sevensixd);
	printf("7_7a: %d\n", sevensevena);
	printf("7_7b: %d\n", sevensevenb);
	printf("7_7c: %d\n", sevensevenc);
	printf("7_7d: %d\n", sevensevend);
	printf("7_8a: %d\n", seveneighta);
	printf("7_8b: %d (ignore)\n", seveneightb);
	printf("7_8c: %d\n", seveneightc);
	printf("7_8d: %d (ignore)\n", seveneightd);
	...
	printf("8_8a: %d\n", eighteight_a);
	printf("8_8b: %d\n", eighteight_b);
	printf("8_8c: %d (ignore)\n", eighteight_c);
	printf("8_8d: %d (ignore)\n", eighteight_d);
	printf("8_9a: %d (none yet)\n", eightnine_a);
	printf("8_9b: %d (none yet)\n", eightnine_b);
	printf("8_9c: %d (none yet)\n", eightnine_c);
	printf("8_9d: %d (none yet)\n", eightnine_d);
	printf("8_10a: %d (none yet)\n", eightten_a);
	printf("8_10b: %d (none yet)\n", eightten_b);
	printf("8_10c: %d (none yet)\n", eightten_c);
	printf("8_10d: %d (none yet)\n", eightten_d);
	printf("8_11a: %d\n", eighteleven_a);
	printf("8_11b: %d\n", eighteleven_b);
	printf("8_11c: %d\n", eighteleven_c);
	printf("8_11d: %d\n", eighteleven_d);
...
////v2
	...
	printf("n3_1sd: %d\n", n3_1sd);
	printf("o3_1a: %d\n", o3_1a);
	printf("o3_1b: %d (ignore)\n", o3_1b);
	printf("o3_1c: %d\n", o3_1c);
	printf("o3_1d: %d (ignore)\n", o3_1d);
	printf("o3_1sa: %d\n", o3_1sa);
	printf("o3_1sb: %d (ignore)\n", o3_1sb);
	printf("o3_1sc: %d\n", o3_1sc);
	printf("o3_1sd: %d (ignore)\n", o3_1sd);
////v2
	printf("u3_1a: %d\n", u3_1a);
	printf("u3_1b: %d (ignore)\n", u3_1b);
	printf("u3_1c: %d\n", u3_1c);
	printf("u3_1d: %d (ignore)\n", u3_1d);
