double
get_Beta(double fugacity) /* This is the section_section version */
{
...
/************************************************/
	...
	for (i=1;i<= max_keynum;i++){ /* take sum over corresponding components of the eigenvectors */
	...
	for (i = 1; i <= max_keynum; i++) {	/* loop through each component of the eigenvector */
