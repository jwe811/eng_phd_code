...
The text files will be called SectionTransferMatrixL%dM%d_binary.txt and TspanTransferMatrixL%dM%d_binary.txt
*/
...
#define	L 7				/* number of horizontal edges                              */
...
/************************************************************************************************/
	...
	sprintf(filename, "SectionTransferMatrixL%dM%d_Binary.txt", L, M);
...
/************************************************************************************************/
	...
	sprintf(filename, "TspanTransferMatrixL%dM%d_Binary.txt", L, M);
	fp = fopen(filename, "w");	//create or overwrite the file "filename"
