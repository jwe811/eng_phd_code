...
*/			totalsecs++;
	...
	double max_Evalue;
	max_Evalue = max_eval_LRvec(connectivity_inv); //max_eval_LRvec() returns max eigenvalue-1
...
*/
	...
	sprintf(filename, "L_Evector_TS_L%dM%d_test.txt", L, M);
	sprintf(filename2, "R_Evector_TS_L%dM%d_test.txt", L, M);
