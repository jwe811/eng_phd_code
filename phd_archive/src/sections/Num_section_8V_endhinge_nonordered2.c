...
num_section_endhinge_norder3(void)
{
	...
	unsigned short int slot_num[9];	/*of the positions available to the edge determined by*/
...
for (i=1;i <= 8;i++){slot_num[i]=0;} /* This is necessary to initialize the array to contain zero elements */
...
if (slot_num[7] !=0){
	return(7777.0*slot_num[1]-9119.0+1111.0*slot_num[2]+185.0*slot_num[3]+37.0*slot_num[4]+9.0*slot_num[5]+3.0*slot_num[6]+slot_num[7]);
}
if (slot_num[5] !=0){
	return(7777.0*slot_num[1]-9119.0+1111.0*slot_num[2]+185.0*slot_num[3]+37.0*slot_num[4]+9.0*slot_num[5]+3.0*slot_num[6]);
}
if (slot_num[3] !=0){
	return(7777.0*slot_num[1]-9108.0+1111.0*slot_num[2]+185.0*slot_num[3]+37.0*slot_num[4]);
}
	return(7777.0*slot_num[1]-8887.0+1111.0*slot_num[2]);
