/*
COMPACT CASE, SO ONLY SECTIONS/T-SPANS THAT HAVE A FULL HINGE
BINARY CASE, SO TRANSFER MATRIX WILL CONTAIN ONLY ZEROS AND ONES. ZERO IF THERE IS NOT A CONNECTION--ONE IF THERE IS.
...
The text files will be called SectionTransferMatrixL%dM%d_Compact_Binary.txt and TspanTransferMatrixL%dM%d_Compact_Binary.txt
*/
...
/************************************************************************************************/
	...
	sprintf(filename, "SectionTransferMatrixL%dM%d_Compact_Binary.txt", L, M);
...
/************************************************************************************************/
	...
	sprintf(filename, "TspanTransferMatrixL%dM%d_Compact_Binary.txt", L, M);
	fp = fopen(filename, "w");	//create or overwrite the file "filename"
