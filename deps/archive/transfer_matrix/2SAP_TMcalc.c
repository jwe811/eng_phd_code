...
#define x_L 0.45	/* left end point to use in bracketing method to find x_0        */
#define x_R 0.68	/* right end point to use in bracketing method to find x_0       */
...
unsigned long int num_tspans=0;	//number of saved tspans
