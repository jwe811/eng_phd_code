//Takes a Link file (LP format) and will create a new file with their linking numbers
...
int main(void) {
	...
	for(curfile=1; curfile<=totfiles; curfile++){
		...
		////////////////////Output file///////////////////////
		sprintf(Outputname, "MC2SAPsHamL%dM%dspan%drun1num%d_LP_LN.txt", L, M, span, curfile);	//CHANGEABLE
